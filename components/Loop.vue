<template>
  <div class="flex h-full flex-col items-center justify-center">
    <div class="loop aspect-square h-[20rem]">
      <svg
        ref="loop"
  ...
  methods: {
    createLoopSVG() {
      ...
      const createSector = (
        ...
        // Cache outer arcs
        if (track == 0) {
          const arcElement = arcStrokePath(
            v1x,
            v1y,
            v2x,
            v2y,
      ...
      const sectorFillPath = (
        ...
        const sectorElement = document.createElementNS(
      ...
      const arcStrokePath = (
        ...
        const arcElement = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "path",
        );
      ...
      for (let track = 0; track < tracks; track++) {
        ...
        for (let beat = 0; beat < beats; beat++) {
          ...
          createSector(
            ...
            track,
            beat,
          ).forEach((element) => loop.appendChild(element));
        }
      }
    },
  },
